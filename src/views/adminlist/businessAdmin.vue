    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogFormVisible" @close='closeDialog'>
      <el-form ref="dataForm" :rules="rules" :model="Temp" autocomplete="new" label-position="left" label-width="80px" style="width:400px;margin-left: 50px;">
        ...
        <el-form-item  label="密码" prop="password">
          ...
          <el-input placeholder="5-12位字母/数字/下划线组成" v-model="Temp.password" type="text" onfocus="type:'password'" autocomplete="new"></el-input>
        </el-form-item>
        <el-form-item label="确认密码" prop="password2">
          <el-input type="password" style="display: none"/>
          <el-input placeholder="再次输入密码" v-model="Temp.password2" type="text"  onfocus="type:'password'" autocomplete="new"></el-input>
        </el-form-item>
